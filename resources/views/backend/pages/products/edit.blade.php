    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{ Route('backend.products.update',$product->id) }}"
                    autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <x-backend.form.input label="{{ trans('products_trans.Options') }}" name="options"
                                    value="{{ $product->options }}" class="form-control" />
                            </div>
                        </div>

                        <div class="col-md-4">
                            <div class="form-group">
                                <x-backend.form.input label="{{ trans('products_trans.Rating') }}" name="rating"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <x-backend.form.input label="{{ trans('products_trans.Featured') }}" name="featured"
                                    value="{{ $product->featured }}" class="form-control" />
                            </div>
                        </div>
