    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{Route('backend.brands.update',[$brand->id])}}" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                label="{{ trans('brands_trans.Info') }}"
                                name="info" value="{{$brand->info}}" />
                            </div>
                        </div>
