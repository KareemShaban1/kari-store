...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">{{ trans('admins_trans.Edit_Brand') }}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#"
                        class="default-color">{{ trans('admins_trans.Edit_Brand') }}</a></li>
                <li class="breadcrumb-item active">{{ trans('admins_trans.Brands') }}</li>
            </ol>
        </div>
    </div>
</div>
        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data"
                    action="{{ Route('backend.admins.update',$admin->id) }}" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <x-backend.form.input label="{{ trans('admins_trans.Name') }}" name="name"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <x-backend.form.input label="{{ trans('admins_trans.Password') }}" name="name"
                                    :value="$admin->password" class="form-control" type="password" />
