    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{Route('backend.banners.update',[$banner->id])}}" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <x-backend.form.input label="{{ trans('banners_trans.Banner_Name') }}" name="banner_name"
                                :value="$banner->banner_name" class="form-control" />
