    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{ Route('backend.websiteParts.store') }}"
                    autocomplete="off">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                  ...
                                  <div class="form-check">
                                    <input class="form-check-input" type="radio" name="value" value="0" checked>
                                    <label class="form-check-label" >
