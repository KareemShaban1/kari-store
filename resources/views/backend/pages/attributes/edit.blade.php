    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{ Route('backend.attributes.update',$attribute->id) }}"
                    autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <x-backend.form.input value="{{$attribute->name}}" label="{{ trans('attributes_trans.Attribute_Name') }}" name="name"
                                    class="form-control" />
                            </div>
                        </div>
                    </div>
