...
@section('title')
    {{ trans('payments_trans.Add_Payment_Gateway') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> {{ trans('payments_trans.Add_Payment_Gateway') }}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#"
                        class="default-color">{{ trans('payments_trans.Add_Payment_Gateway') }}</a></li>
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{ Route('admin.paymentGateways.store') }}"
                    autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <x-backend.form.input label="{{ trans('payments_trans.Gateway_Name') }}" name="name"
                                    class="form-control" />
                            </div>
                        </div>
                    ...
                    <button type="submit"
                        class="btn btn-success btn-md nextBtn btn-lg ">{{ trans('payments_trans.Add') }}</button>
