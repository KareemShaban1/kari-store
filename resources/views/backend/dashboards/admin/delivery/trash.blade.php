                        ...
                        <tbody>
                            @foreach ($brands as $brand)
                                <tr>
                                    <td>
                                        @if ($brand->image)
                                            <img src="{{ asset('storage/' . $brand->image) }}" height="50" width="50"
                                                alt="">
                                        @else
                                    ...
                                    <td>
                                        <form action="{{ Route('backend.brands.restore', $brand->id) }}" method="post"
                                        ...
                                        <form action="{{ Route('backend.brands.forceDelete', $brand->id) }}" method="post"
                                            style="display:inline">
                                            @csrf
                                            @method('delete')
