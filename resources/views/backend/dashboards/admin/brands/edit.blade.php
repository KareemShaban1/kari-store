...
@section('page-header')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0">{{ trans('brands_trans.Edit_Brand') }}</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                    <li class="breadcrumb-item"><a href="#"
                            class="default-color">{{ trans('brands_trans.Edit_Brand') }}</a></li>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data"
                        action="{{ Route('admin.brands.update', [$brand->id]) }}" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <x-backend.form.textarea label="{{ trans('brands_trans.Info') }}" name="info"
                                        value="{{ $brand->info }}" />
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="border rounded-lg text-center p-3">
                                    <img src="{{ $brand->image_url }}" height="200" width="200" class="img-fluid"
                                        id="frame" />
                                </div>
                            </div>
                        </div>
                        ...
                        <button type="submit"
                            class="btn btn-success btn-md nextBtn btn-lg ">{{ trans('brands_trans.Edit') }}</button>
