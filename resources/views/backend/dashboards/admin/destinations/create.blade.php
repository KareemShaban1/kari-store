                ...
                <div class="card-body">
                    ...
                    <form action="{{ Route('admin.destinations.store') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <x-backend.form.input label="{{ trans('destinations_trans.Place_Name') }}"
                                        name="name" class="form-control" required="required" value='' />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label> {{ trans('destinations_trans.Parent') }}<span
