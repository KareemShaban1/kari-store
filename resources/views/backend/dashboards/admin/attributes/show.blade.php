                    ...
                    <table id="table_id" class="display">
                        <thead>
                            <tr>
                                ...
                                <th>{{ trans('attribute_values_trans.Attribute_Name') }}</th>
                                <th>{{ trans('attribute_values_trans.Key') }}</th>
                        ...
                        <tbody>
                            @foreach ($attribute->attribute_values as $attribute_value)
                                <tr>
                                    ...
                                    <td>{{ $attribute_value->key }}</td>
                                    <td>{{ $attribute_value->value }}</td>
                                    <td><input type="color" value="{{ $attribute_value->value }}" disabled></td>
                                    <td>
                                        <a href="" class="btn btn-primary btn-sm">
                                            <i class="fa fa-eye"></i>
                                        </a>

                                        <a href="{{ Route('backend.attribute_values.edit', $attribute_value->id) }}"
                                        ...
                                        <form
                                            action="{{ Route('backend.attribute_values.destroy', $attribute_value->id) }}"
