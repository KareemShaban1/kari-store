            ...
            <div class="scrollbar side-menu-bg">
                ...
                <li>
                    ...
                    <ul id="reports_management" class="collapse" data-parent="#sidebarnav">
                        ...
                        <li>
                            <a href="javascript:void(0);" data-toggle="collapse" data-target="#order-reports">
                                <div class="pull-left"><i class="fa-brands fa-product-hunt"></i><span
                                        class="right-nav-text">{{ trans('sidebar_trans.Products_Reports') }} </span>
                                </div>
                                <div class="pull-right"><i class="ti-plus"></i></div>
                                <div class="clearfix"></div>
                            </a>
                            <ul id="order-reports" class="collapse">
                                <li> <a href="">{{ trans('sidebar_trans.Products_Most_Sold') }}
                                    </a>
                                </li>
                                <li> <a href="">{{ trans('sidebar_trans.Offer_Products') }}</a>
                                </li>
                        ...
                        <li>
                            <a href="javascript:void(0);" data-toggle="collapse" data-target="#order-reports">
                                <div class="pull-left"><i class="fa-solid fa-store"></i><span
                                        class="right-nav-text">{{ trans('sidebar_trans.Stores_Reports') }} </span>
                                </div>
                                <div class="pull-right"><i class="ti-plus"></i></div>
                                <div class="clearfix"></div>
                            </a>
                            <ul id="order-reports" class="collapse">
                                <li> <a href="">{{ trans('sidebar_trans.Stores_Most_Sold') }}
                                    </a>
                                </li>
                                <li> <a href="">{{ trans('sidebar_trans.Stores_Most_Products') }}</a>
                                </li>
