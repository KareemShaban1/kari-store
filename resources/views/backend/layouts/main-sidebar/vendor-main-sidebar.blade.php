        ...
        <div class="side-menu-fixed">
            <div class="scrollbar side-menu-bg">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <!-- menu item Dashboard-->
                    <li>
                        <a href="{{Route('vendor.dashboard')}}"><i class="fa-solid fa-house fa-fade"></i><span class="right-nav-text">
                    ...
                    <li>
                        ...
                        <ul id="products-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{Route('vendor.products.create')}}">{{ trans('sidebar_trans.Add_Product') }} </a> </li>
                            <li> <a href="{{Route('vendor.products.index')}}">{{ trans('sidebar_trans.All_Products') }}</a> </li>
                    ...
                    <li>
                     ...
                     <li>
                        ...
                        <ul id="coupons-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{Route('vendor.coupons.create')}}">{{ trans('sidebar_trans.Add_Coupon') }} </a> </li>
                            <li> <a href="{{Route('vendor.coupons.index')}}">{{ trans('sidebar_trans.All_Coupons') }}</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="orders-menu" class="collapse" data-parent="#sidebarnav">
                            ...
                            <li> <a href="{{Route('vendor.orders.index')}}">{{ trans('sidebar_trans.All_Orders') }}</a> </li>
                        </ul>
                    </li>
