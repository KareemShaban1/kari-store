...
trait UploadImageTrait
{
    ...
    //         Storage::put($thumbnailPath . '/' . $newImageName, $imgFile->encode());

    //         // Store the original image in storage
    //         Storage::put($uploadPath . '/' . $newImageName, file_get_contents($image));
    ...
    // {
    //     // Delete the image file from the storage directory
    //     $thumbnailPath = 'thumbnail/' . $folder_name . '/' . $imagePath;
    //     $uploadPath = 'uploads/' . $folder_name . '/' . $imagePath;
